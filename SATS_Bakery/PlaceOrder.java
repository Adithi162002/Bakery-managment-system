...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtquantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 240, 250, -1));
        ...
        getContentPane().add(txtsearch1, new org.netbeans.lib.awtextra.AbsoluteConstraints(369, 248, 250, -1));

        txtsearch2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtsearch2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtsearch2KeyReleased(evt);
            }
        });
        getContentPane().add(txtsearch2, new org.netbeans.lib.awtextra.AbsoluteConstraints(369, 248, 250, -1));
    ...
    private void txtquantityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtquantityKeyReleased
        // TODO add your handling code here:
        String name = txtquantity.getText();
        String category = (String) jComboBox1.getSelectedItem();
